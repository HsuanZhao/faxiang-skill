# 法官造像 · 中国法官法律方法论蒸馏 Skill

> 法官不发微博，不开播客，不接受"人生访谈"。他/她唯一持续、公开、可信的自我表达，是判决书里的说理段落，和期刊上的署名文章。

一个用于 Claude（Claude Code / Claude Desktop 等支持 Skill 的环境）的自定义 Skill：输入一位中国法官（在任或退休）的姓名与任职法院信息，自动完成学术论文、裁判文书说理、案例评析、学术会议发言等多源调研，提炼其**法律方法论**，最终生成一个可运行、可交互的"法官视角"Skill。
